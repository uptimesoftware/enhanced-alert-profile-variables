...
public class AlertTemplateFiller {
        ...
        public AlertMessage fillTemplate(AlertMessage template, NotificationInfo info) {
                ...
                templateParser.setBuffer(new StringBuffer(subject));
                String convertedSubject = templateParser.parseBuffer().toString();

                templateParser.setBuffer(new StringBuffer(body));
                String convertedBody = templateParser.parseBuffer().toString();
